                ...
                <div class="col">
                    <div class="card border-0">
                        <div class="card-header border-0 bg-light">
                            <b>Blog manage</b>
                            <a href="#" class="cancel btn-sm btn-danger float-right"> &nbsp; ยกเลิก &nbsp; </a>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="content-form">
                                <form method="POST" action="admin/blog/" class="form-horizontal" enctype="multipart/form-data">
                                    <div class="row">
                                        <div class="col-8">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6 mt-4">
                                            <div class="float-lg-right">
                                                <button type="cancel" class="btn btn-danger mr-2"> &nbsp; ยกเลิก &nbsp; </button>
